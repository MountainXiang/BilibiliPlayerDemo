...
//    UIAlertController *alert = [UIAlertController alertControllerWithTitle:nil message:[barcode getBarcodeData] preferredStyle:UIAlertControllerStyleAlert];
//    [self presentViewController:alert animated:YES completion:nil];
    
    UIAlertController *alert = [[UIAlertController alloc] init];
    alert.title = [barcode getBarcodeData];
    [alert addAction:[UIAlertAction actionWithTitle:@"播放" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        NSURL *url = [NSURL URLWithString:alert.title];

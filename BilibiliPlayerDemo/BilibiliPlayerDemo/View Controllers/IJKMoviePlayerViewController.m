...
+ (void)presentFromViewController:(UIViewController *)viewController withTitle:(NSString *)title URL:(NSURL *)url completion:(void (^)(void))completion {
    ...
    historyItem.url = url;
    //test
//    historyItem.url = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"class_9_the_human_ear_01" ofType:@"flv"]];
//    historyItem.url = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"NOW+YOONA" ofType:@"mp4"]];
...
- (instancetype)initWithURL:(NSURL *)url {
    ...
    if (self) {
        self.url = url;
        //test
//        self.url = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"class_9_the_human_ear_01" ofType:@"flv"]];
//        self.url = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"NOW+YOONA" ofType:@"mp4"]];
    }
    return self;
}
